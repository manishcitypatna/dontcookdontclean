...
export default function ThankYouPopup({
  ...
  onClose,
  title = "Thank You!",
  message = "Your inquiry has been successfully received. We are already looking for the perfect match for your home.",
  showAssistance = true,
  showGuarantee = true,
  children,
}: ThankYouPopupProps) {
            ...
            <div className="bg-white rounded-[24px] shadow-[0_10px_30px_rgba(0,0,0,0.08)] max-w-lg w-full relative">
              <div className="p-6">
                ...
                <div className="text-center mb-6">
                  ...
                  <h2 className="h3 text-text-primary">{title}</h2>
                  <p className="mt-2 body text-text-secondary">{message}</p>
                </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start gap-3">
                        <svg className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 80 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
